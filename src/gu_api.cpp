...
double GU_PCM_Source_CalculatePitch(PCM_source* source, int channels, const double timeStart, const double timeEnd, const int windowSize, const int overlap)
{
#ifdef _DEBUG
	...
	return AudioSource{source}.CalculatePitch(channels, timeStart, timeEnd, windowSize, overlap);
}